...
import { slipUpload } from "../../redux/features/slipSlice";
import "./style.css";
import { Link } from "react-router-dom";
import dayjs from "dayjs";
import "dayjs/locale/id";

const Payment = ({ mobilName, kategori, totalPrice, selectedBank }) => {
    ...
    const totalPriceParam = useParams().totalPrice;
        ...
        <>
            ...
            <div className="payment-flexbox">
                <div>
                    ...
                    <Bank totalPrice={totalPriceParam} />
                </div>
                {!isConfirmed && (
